...
angular.module('app.gallery.remote.controller', [])
.controller('VRPlayCtrl', function($scope, $rootScope, socket, $stateParams, vidUtils, join, $state) {
    ...
    // if($rootScope.global.room){
    //   console.log('there was an error redirecting now');
    //   $state.go('ERROR', {msg: $rootScope.global.room.msg});
    // }
