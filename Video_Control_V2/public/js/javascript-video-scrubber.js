...
// var totalFrames = 141; // the number of images in the sequence of JPEG files (this could be calculated server-side by scanning the frames folder)
...
window.requestAnimFrame = (function(){ // reduce CPU consumption, improve performance and make this possible
  return  window.requestAnimationFrame       || 
    ...
    for(i = 0; i < totalFrames; i++) { // loop for each image in sequence
      ...
      images[i].src = "./frames/frame_"+pad(i, 3)+".png"; // set the source of the image object
    }
